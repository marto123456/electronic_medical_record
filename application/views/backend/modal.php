	...
	function showAjaxModal(url)
	{
		...
		jQuery('#modal_ajax .modal-body').html('<br><br><br><br><div style="text-align:center;margin-top:800px;"><img src="<?php echo base_url();?>assets/images/preloader.gif" /></div>');
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" id="modal_ajax">
        <div class="modal-dialog modal-lg">
            <div class="modal-content slimscrollsidebar">
                <div class="modal-body " style="height:auto"></div>
            </div>
        </div>
    </div>
