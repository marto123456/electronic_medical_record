...
?>
                <div class="chat-main-box">
                    ...
                    <li>
                        <a href="<?php echo site_url('health_worker/message/message_read/' . $row['message_thread_code']);?>" class="<?php if(isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active' ;?>">
                        ...
                        <div class="chat-main-header">
                            ...
                            ?>
                                ...
                                <div class="btn-group pull-right">
                                    <button class="btn btn-small btn-outline" data-toggle="dropdown"> <i class="icon-options-vertical"></i></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url(); ?>health_worker/message/message_new">New Message</a> 
                                        </li>
                                    </ul>
                                </div><br>
                            </div>
                    ...
                    if(e.which == 13) {
                        ...
                        var message = $("textarea#message").val();
                         if (message == "") {
                            ...
                            jQuery.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>" + "health_worker/message/send_reply/<?php echo $current_message_thread_code?>",
                            dataType: 'json',
